...
For the stack explanation, open `docs/public/STACK_REVIEW_BRIEF.md`.
...
| 9 | `docs/public/STACK_REVIEW_BRIEF.md` | The stack is explained with purpose, current state, remaining work, and proof commands. |
