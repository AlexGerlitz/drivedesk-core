...
| 4 | Adapter Studio | Runtime catalog, connector certification, fixture replay, Integration Runtime, Integration Execution, standalone replay API, and generated SDK operation plans show how an external provider is connected without exposing secrets. | `adapterStudio`, `connectorFixtureReplay`, `integrationRuntime`, `integrationExecution`, `GET /demo/connector-fixture-replay`, `GET /demo/integration-runtime`, `GET /demo/integration-execution`, `CONNECTOR_CERTIFICATION.md`, `CONNECTOR_FIXTURE_REPLAY.md`, `INTEGRATION_RUNTIME.md`, `INTEGRATION_EXECUTION.md`, `adapter_runtime.previewed`, `integration_execution.run_ledger_prepared`, `sdk/generated/public-demo/` |
