...
7. Inspect `docs/openapi.json`, `GET /demo/public`, `GET /demo/connector-fixture-replay`, and `GET /demo/business-scenario-replay`.
...
16. Run `bash scripts/check_public_business_scenario_replay.sh`.
17. Run `bash scripts/check_public_observability_proof.sh`.
18. Run `bash scripts/check_public_alert_routing.sh`.
19. Run `bash scripts/check_public_connector_certification.sh`.
20. Run `bash scripts/check_public_connector_fixture_replay.sh`.
21. Run the capability-specific verifier from the table above.
