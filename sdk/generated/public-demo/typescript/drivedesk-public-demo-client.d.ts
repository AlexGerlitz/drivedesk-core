...
export const REQUIRED_FIELDS: Array<"schemaVersion" | "generatedAt" | "dataSource" | "apiContract" | "tenant" | "health" | "metrics" | "workQueue" | "members" | "auditEvents" | "outbox" | "adapters" | "adapterScenarios" | "adapterStudio" | "connectorCertification" | "providerOnboarding" | "integrationRuntime" | "integrationExecution" | "integrationRepair" | "observabilityDashboard" | "notificationDelivery" | "connectorFixtureReplay" | "businessIntakePipeline" | "businessTaskHandoff" | "businessNotificationChannels" | "businessContextAssistant" | "businessActionExecution" | "businessApprovalGateway" | "integrationJobs" | "integrationHealth" | "integrationReadiness" | "recoveryEvidence" | "alertRouting" | "incidentResponse" | "businessControlTower" | "businessScenarioReplay" | "stackReadiness" | "engineeringProof" | "workflow" | "workflowScenarios" | "endToEndScenario" | "timeline" | "domainEvents">;
...
export const PROVIDER_ONBOARDING_REQUIRED_FIELDS: Array<"status" | "command" | "onboardingLevel" | "providerKey" | "providerName" | "providerCategory" | "readinessScore" | "readinessStatus" | "summary" | "providerProfile" | "onboardingStages" | "readinessGates" | "readinessBlockers" | "privateConnectorHandoff" | "mappingPreview" | "preflightChecks" | "sandboxContract" | "rolloutPlan" | "dataBoundaries" | "api" | "docs">;
