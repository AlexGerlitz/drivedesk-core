...
| API contract | Read-only synthetic demo API, standalone connector replay API, standalone business scenario replay API, and generated OpenAPI schema are present. | `docs/openapi.json`, `GET /demo/public`, `GET /demo/connector-fixture-replay`, `GET /demo/business-scenario-replay`, `docs/public/API_BACKED_DEMO.md` | `bash scripts/check_public_demo_api.sh && bash scripts/check_public_business_scenario_replay.sh` |
