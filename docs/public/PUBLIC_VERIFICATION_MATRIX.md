...
| Stack explanation is reviewable | `docs/public/STACK_REVIEW_BRIEF.md`, `docs/public/evidence/stack-review-brief.sanitized.json` | `bash scripts/check_public_stack_review_brief.sh` | Each major stack has a plain-language purpose, current state, remaining work, related evidence, and public-safe boundary. |
