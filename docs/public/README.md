...
17. Read the integration connections overview.
18. Read the integration adapters overview.
19. Read the integration observability overview.
20. Read the outbox recovery overview.
21. Read the case study.
22. Check CI and public demo health workflow results.
23. Run the public smoke checks locally.
