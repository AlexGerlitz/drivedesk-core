...
| Read-only API contract | FastAPI `GET /demo/public`, `GET /demo/connector-fixture-replay`, `GET /demo/business-intake-pipeline`, `GET /demo/business-task-handoff`, `GET /demo/business-scenario-replay`, and generated `docs/openapi.json` | `docs/public/API_BACKED_DEMO.md`, `examples/curl/demo-public.sh` | `bash scripts/check_public_demo_api.sh` |
...
7. Inspect `docs/openapi.json`, `GET /demo/public`, `GET /demo/connector-fixture-replay`, `GET /demo/business-intake-pipeline`, `GET /demo/business-task-handoff`, and `GET /demo/business-scenario-replay`.
...
18. Run `bash scripts/check_public_business_scenario_replay.sh`.
19. Run `bash scripts/check_public_observability_proof.sh`.
20. Run `bash scripts/check_public_alert_routing.sh`.
21. Run `bash scripts/check_public_connector_certification.sh`.
22. Run `bash scripts/check_public_connector_fixture_replay.sh`.
23. Run the capability-specific verifier from the table above.
