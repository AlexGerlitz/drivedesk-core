...
def _public_notification_delivery() -> dict[str, Any]:
    return {
        "status": "validated",
        ...
        "observability": [
            {
                ...
                "safeLabels": ["channel", "status", "adapter_key"],
                "containsPii": False,
                "rawPayloadIncluded": False,
            ...
            },
            {
                ...
                "safeLabels": ["channel", "adapter_key"],
                "containsPii": False,
                "rawPayloadIncluded": False,
                "evidence": "notification_delivery.metric.bound",
            },
            {
                ...
                "safeLabels": ["channel", "event_type", "status"],
                "containsPii": False,
                "rawPayloadIncluded": False,
...
def build_public_demo_payload() -> dict[str, Any]:
    return {
        ...
        "notificationDelivery": _public_notification_delivery(),
