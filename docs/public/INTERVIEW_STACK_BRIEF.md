...
- Provider sandbox dry-run: before a real CRM connector writes anything, I
  ...
  behavior, operator CLI output, redaction, rate limits, and reconciliation
  evidence without exposing provider tokens.
