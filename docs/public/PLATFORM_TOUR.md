...
| 4 | Adapter Studio | Runtime catalog and generated SDK operation plans show how an external provider is connected without exposing secrets. | `adapterStudio`, `sdk/generated/public-demo/` |
...
4. `Integrations` - Adapter Studio, adapter contracts, operation scenarios,
   sync jobs, and health.
