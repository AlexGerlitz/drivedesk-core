...
| API contract | Read-only synthetic demo API, standalone connector replay API, standalone business intake pipeline API, standalone business task handoff API, standalone business scenario replay API, and generated OpenAPI schema are present. | `docs/openapi.json`, `GET /demo/public`, `GET /demo/connector-fixture-replay`, `GET /demo/business-intake-pipeline`, `GET /demo/business-task-handoff`, `GET /demo/business-scenario-replay`, `docs/public/API_BACKED_DEMO.md` | `bash scripts/check_public_demo_api.sh && bash scripts/check_public_business_intake_pipeline.sh && bash scripts/check_public_business_task_handoff.sh && bash scripts/check_public_business_scenario_replay.sh` |
