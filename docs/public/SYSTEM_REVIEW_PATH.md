...
the public root, demo, API, SDK, operations evidence, incident response, release
safety, GitOps, OpenTofu, and evidence index into one verifiable chain.
...
| --- | --- | --- |
| 1 | GitHub Pages root review hub | The public entrypoint is generated by the export pipeline and links demo, docs, OpenAPI, CI, and evidence. |
| 2 | `apps/admin/public-demo/` Workflow, Operations, Incidents, and Proof tabs | The demo exposes executable system behavior, not a static screenshot. |
| 3 | `docs/public/PROJECT_STATUS.md` | Current validated state, limits, and next engineering work are explicit. |
...
| 5 | `docs/public/ENGINEERING_PROOF.md` | The demo Proof tab, API payload, OpenAPI schema, SDK, docs, and CI gates share one proof contract. |
