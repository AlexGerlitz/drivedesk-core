...
13. Run `bash scripts/check_public_observability_proof.sh`.
14. Run `bash scripts/check_public_alert_routing.sh`.
15. Run the capability-specific verifier from the table above.
