...
| 4 | Adapter Studio | Runtime catalog, connector certification, fixture replay, and generated SDK operation plans show how an external provider is connected without exposing secrets. | `adapterStudio`, `CONNECTOR_CERTIFICATION.md`, `CONNECTOR_FIXTURE_REPLAY.md`, `sdk/generated/public-demo/` |
